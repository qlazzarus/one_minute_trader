...
export default class MiningScene extends Phaser.Scene {
  ...
  create() {
    ...
    console.log('[Phase 1.3] MiningScene stub mounted.');
    setMode(GameModes.MINING);

    this.add.rectangle(width / 2, height / 2, width, height, THEME.colors.background, 0.92);

    this.add
      .text(width / 2, height / 2 - 20, 'Mining mode is under construction.', {
    ...
    this.input.once('pointerdown', () => {
      console.log('[Phase 1.3] Returning to MainMenuScene from MiningScene.');
